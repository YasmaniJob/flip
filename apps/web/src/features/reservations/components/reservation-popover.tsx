    ...
    return (
        <>
            ...
            <ActionConfirm
                ...
                description={`Estás por liberar el horario de ${slot.staff?.name || 'la sesión'} en el calendario AIP. Esta acción permitirá que otros docentes ocupen el aula en este bloque pedagógico.`}

...
export function InventoryHeader({ resources, statusFilter, onStatusFilterChange }: InventoryHeaderProps) {
    ...
    const cards = [
        ...
        },
        {
            ...
            borderClass: 'border-border hover:bg-muted/30',
            activeClass: 'border-emerald-500 bg-emerald-50/50 dark:bg-emerald-500/5',
        },
        {
            id: 'prestado',
            title: 'Prestados',
            ...
            borderClass: 'border-border hover:bg-muted/30',
            activeClass: 'border-blue-500 bg-blue-50/50 dark:bg-blue-500/5',
        },
        {
            id: 'mantenimiento',
            title: 'En Taller',
            ...
            borderClass: 'border-border hover:bg-muted/30',
            activeClass: 'border-amber-500 bg-amber-50/50 dark:bg-amber-500/5',
        },
        {
            id: 'baja',
            title: 'De Baja',
            ...
            borderClass: 'border-border hover:bg-muted/30',
            activeClass: 'border-rose-500 bg-rose-50/50 dark:bg-rose-500/5',
        }
    ];
